...
static void group_test_block_entry(struct motor_block *self, const struct motor_block_in *in,
...
static struct motor_block block_a = {
	.name = "subsys_a_block",
	.stage = MOTOR_STAGE_INNER_ISR,
	.period_div = 1U,
	.entry = group_test_block_entry,
};
static struct motor_block block_b = {
	.name = "subsys_b_block",
	.stage = MOTOR_STAGE_INNER_ISR,
	.period_div = 1U,
	.entry = group_test_block_entry,
};
static struct motor_block *const blocks_a[] = { &block_a };
static struct motor_block *const blocks_b[] = { &block_b };
...
{
	motor_a.sensor_samples[0] = 0.0f;
	motor_a.sensor_sample_count = 1U;
...
{
	motor_b.sensor_samples[0] = 0.0f;
	motor_b.sensor_sample_count = 1U;
